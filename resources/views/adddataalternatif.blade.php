              ...
              <form method="POST" action="{{ url('/alternatif/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="peringkat" placeholder="Nilai Kriteria (Peringkat)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="unduhan" placeholder="Nilai Kriteria (Unduhan)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="aktif" class="col-sm-2 col-form-label">C4</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="aktif" placeholder="Nilai Kriteria (Aktif)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="manfaat" class="col-sm-2 col-form-label">C5</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="manfaat" placeholder="Nilai Kriteria (Manfaat)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="kelebihan" class="col-sm-2 col-form-label">C6</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kelebihan" placeholder="Nilai Kriteria (Kelebihan)" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
