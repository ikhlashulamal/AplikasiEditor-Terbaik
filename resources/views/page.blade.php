...
<head>
  ...
  <title>CRUD APLIKASI TERBAIK</title>
...
<div class="wrapper">
  ...
  <a href="#" class="brand-link">
    ...
    <span class="brand-text font-weight-light"><b>APLIKASI EDITOR'S</b></span>
  </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('dataaplikasi') }}" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Data Aplikasi
                <i class="right fas fa-angle"></i>
  ...
  <footer class="main-footer">
    ...
    Pemilihan Aplikasi Editor's Terbaik
